...
def built_AMPC_parser():
    ...
    if mode == 'testing':
        test_dir = os.path.dirname(__file__) + '/results/integrate_3lane/experiment-2021-05-10-20-58-46'
    ...
    parser.add_argument('--num_workers', type=int, default=8, help='default=4')
    parser.add_argument('--num_learners', type=int, default=16, help='default=10')
    parser.add_argument('--num_buffers', type=int, default=8, help='default=4')
...
def main(alg_name):
    ...
    if args.mode == 'training':
        ray.init(object_store_memory=128*1024*1024)  # ray.init(object_store_memory=5120*1024*1024)
